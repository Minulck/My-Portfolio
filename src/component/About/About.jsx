      ...
      <div className="flex flex-col-reverse md:flex-row justify-between items-center">
        <div className="md:w-1/2 text-center md:text-left mt-8 md:mt-8">
          ...
          <p className="text-base sm:text-lg md:text-lg text-gray-400 mb-10 mt-8 leading-relaxed">
            I have a strong background in web development, with a focus on
            creating dynamic and responsive user interfaces. My passion for
            coding drives me to continuously learn and adapt to new
            technologies, ensuring that I stay at the forefront of the industry.
          </p>

          <a
            href="hhttps://drive.google.com/file/d/1Jzs_NkvRR-eb_jgxcwbWbMB3BkdcZ2Km/view?usp=sharing"
            target="_blank"
